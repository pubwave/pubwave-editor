          ...
          content: [
            {
              ...
              content: [
                ...
                {
                  type: 'text',
                  text: ': Medical diagnosis, drug discovery, and personalized treatment plans',
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                ...
                {
                  type: 'text',
                  text: ': Fraud detection, algorithmic trading, and risk assessment',
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                ...
                {
                  type: 'text',
                  text: ': Autonomous vehicles, traffic optimization, and route planning',
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                ...
                {
                  type: 'text',
                  text: ': Personalized learning, intelligent tutoring, and content generation',
                },
              ],
            },
          ],
