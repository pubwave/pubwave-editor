    ...
    extend: {
      colors: {
        pubwave: {
          ...
          'text-secondary': 'var(--pubwave-text-secondary, #374151)',
          'text-tertiary': 'var(--pubwave-text-tertiary, #4b5563)',
          border: 'var(--pubwave-border, #e5e7eb)',
          'border-light': 'var(--pubwave-border-light, #f3f4f6)',
          hover: 'var(--pubwave-hover, rgba(0, 0, 0, 0.03))',
          'hover-bg': 'var(--pubwave-hover-bg, #f3f4f6)',
          'hover-task': 'var(--pubwave-hover-task, #e8f2ff)',
          ...
          'primary-hover': 'var(--pubwave-primary-hover, #2563eb)',
          ...
          'checked-text': 'var(--pubwave-checked-text, #9ca3af)',
        },
      },
      spacing: {
        ...
        'pubwave-1': 'var(--pubwave-spacing-1, 4px)',
        'pubwave-2': 'var(--pubwave-spacing-2, 8px)',
        'pubwave-3': 'var(--pubwave-spacing-3, 12px)',
        'pubwave-4': 'var(--pubwave-spacing-4, 16px)',
        'pubwave-7': 'var(--pubwave-spacing-7, 28px)',
      },
      borderRadius: {
        'pubwave-xs': 'var(--pubwave-radius-xs, 3px)',
        'pubwave-sm': 'var(--pubwave-radius-sm, 4px)',
        'pubwave': 'var(--pubwave-radius, 6px)',
        'pubwave-md': 'var(--pubwave-radius-md, 6px)',
        'pubwave-lg': 'var(--pubwave-radius-lg, 8px)',
      },
      boxShadow: {
      ...
      fontSize: {
        'pubwave-xs': 'var(--pubwave-font-size-xs, 11px)',
        'pubwave-sm': 'var(--pubwave-font-size-sm, 13px)',
        'pubwave-base': 'var(--pubwave-font-size-base, 14px)',
        'pubwave-md': 'var(--pubwave-font-size-md, 1rem)',
      ...
      minHeight: {
        'touch': '44px',
        'pubwave-button': 'var(--pubwave-button-height, 28px)',
        'pubwave-icon': 'var(--pubwave-icon-size, 20px)',
        'pubwave-task-item': 'var(--pubwave-task-item-height, 30px)',
      },
      minWidth: {
        'touch': '44px',
        'pubwave-button': 'var(--pubwave-button-width, 28px)',
        'pubwave-icon': 'var(--pubwave-icon-size, 20px)',
      },
      width: {
        'pubwave-button': 'var(--pubwave-button-width, 28px)',
        'pubwave-icon': 'var(--pubwave-icon-size, 20px)',
        'pubwave-checkbox': 'var(--pubwave-checkbox-size, 20px)',
        'pubwave-checkbox-input': 'var(--pubwave-checkbox-input-size, 16px)',
        'pubwave-divider': 'var(--pubwave-divider-width, 1px)',
        'pubwave-drop-indicator': 'var(--pubwave-drop-indicator-width, 2px)',
      },
      height: {
        'pubwave-button': 'var(--pubwave-button-height, 28px)',
        'pubwave-icon': 'var(--pubwave-icon-size, 20px)',
        'pubwave-checkbox': 'var(--pubwave-checkbox-size, 20px)',
        'pubwave-checkbox-input': 'var(--pubwave-checkbox-input-size, 16px)',
        'pubwave-divider': 'var(--pubwave-divider-height, 20px)',
        'pubwave-drop-indicator': 'var(--pubwave-drop-indicator-height, 2px)',
        'pubwave-task-item': 'var(--pubwave-task-item-height, 30px)',
      },
    },
  },
